...
export const updateProfile = createAsyncThunk(
  ...
  async (payload, { rejectWithValue }) => {
    try {
      // Backend reads plain req.body fields (username, bio, avatarKey) —
      // avatarKey comes from a prior presign+upload step, there's no
      // actual file in this request, so this is sent as JSON.
