...
//   ========================= */
//   useEffect(() => {
//     // 🚨 ANDROID FIX: Android automatically resizes the view when keyboard opens.
//     // If we add margin manually, it creates a huge gap (Double Height).
//     // So we ONLY run this logic on iOS.
...
//           styles.inputBar, 
//           { 
//             // On Android, insets.bottom is usually 0, so this adds a nice 12px padding inside the bar.
//             // On iOS, it adds safe area padding.
//             paddingBottom: Math.max(insets.bottom, 12),
//             marginBottom: keyboardHeight,
//           }
//         ]}
