...
//   const viewed = useRef(new Set());
//   const flatListRef = useRef(null);
//   const scrollToReelIdRef = useRef(null);
...
//   /* SCROLL TO SPECIFIC REEL (from shared content) */
//   useEffect(() => {
//     const scrollToReelId = route.params?.scrollToReelId;
//     if (!scrollToReelId || reels.length === 0) return;

//     // Prevent re-scrolling on subsequent renders
//     if (scrollToReelIdRef.current === scrollToReelId) return;
//     scrollToReelIdRef.current = scrollToReelId;

//     const reelIndex = reels.findIndex((r) => r._id === scrollToReelId);
//     if (reelIndex !== -1) {
//       setTimeout(() => {
...
//     navigation.setParams({ scrollToReelId: undefined });
//   }, [route.params?.scrollToReelId, reels, navigation]);
