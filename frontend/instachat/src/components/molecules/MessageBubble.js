...
const MessageBubble = ({ message, isOwnMessage }) => {
  ...
  return (
    ...
    >
      {/* ===== SHARED CONTENT CARD ===== */}
      {isSharedContent && !message.deletedForEveryone && (
        <SharedContentCard
          type={message.type}
          post={message.sharedPost}
          reel={message.sharedReel}
      ...
      {(displayText || isStoryReply || message.deletedForEveryone) && (
        ...
        >
          ...
          {/* ===== MESSAGE TEXT ===== */}
          {(!!displayText || message.deletedForEveryone) && (
            <Text
              style={[
                styles.text,
                message.deletedForEveryone && styles.deleted,
            ...
            >
              {message.deletedForEveryone ? 'This message was deleted' : displayText}
            </Text>
          )}
        </View>
      )}
